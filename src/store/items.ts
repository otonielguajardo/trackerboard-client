...
const mutations = {
    SET_ALL_ITEMS: (state: ItemState): void => {
        state.allItems = [
            { stage: 'Position', pilot: 'Luke', status: 'green', progress: 10, img: 'luke.png' },
            { stage: 'Position', pilot: 'Greedo', status: 'orange', progress: 42, img: 'greedo.png' },
            ...
            { stage: 'Transit', pilot: 'Zebulba', status: 'green', progress: 59 },
